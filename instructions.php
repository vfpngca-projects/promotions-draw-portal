...
This means that upon the process of making the draws the user have to load data from an external source (via a csv file) in order to satrt the draw.
  ...
  <li>Click SHOW RESULTS button on the top to view the populated results of the draws being made.</li>
  <li>Click  Download results button from the popup dialogue to download the results in a .csv fromat  file.</li>
